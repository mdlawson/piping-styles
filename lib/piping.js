...
(function() {
  ...
  options = {
    ...
    build: {
      ".styl": function(file, code, options, watcher, fn) {
        var e, s, stylus, _lookup;

        try {
          stylus = require("stylus");
          _lookup = stylus.utils.lookup;
          stylus.utils.lookup = function() {
            file = _lookup.apply(this, arguments);
            if (file && (options.includeModules || file.indexOf("node_modules") === -1)) {
              watcher.add(file);
            }
            return file;
          };
  ...
  module.exports = function(ops, out) {
    ...
    build = function(i, o) {
      ...
      if (options.build[type]) {
        ...
        return options.build[type](i, code, options, watcher, function(data) {
          if (options.minify) {
